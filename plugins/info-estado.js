...
//['𝐊𝐚𝐫-𝐁𝐨𝐭', `${md}`]], fakeChannel, m) // await conn.reply(m.chat, bot, m, fakeChannel)

  
  /*conn.sendHydrated(m.chat, estado, `\n${asistencia}\n\n` + wm, imagen1, '', '𝐊𝐚𝐫-𝐁𝐨𝐭', null, null, [
